...
@Component
public class ValidarContraseniaFarma  implements Validator {
 
    public boolean supports(Class<?> clazz) {
        return FarmaceuticoForm.class.isAssignableFrom(clazz);
    }
 
    public void validate(Object target, Errors errors) {
    	FarmaceuticoForm Contrasenia = (FarmaceuticoForm)target;
