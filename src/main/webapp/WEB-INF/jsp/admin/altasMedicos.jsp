        ...
        <div class="col-lg-12">
		    ...
		    <table id="tablaPedidos" class="table table-bordered table-striped">
               <thead>
                  ...
                  <tbody>
                  <tr>
                    <td><a href="/admin/detalleAltaMedico" target="blank">SOL842</a></td>
                    <td>22/03/2017</td>
                  ...
                  <tr>
                    <td><a href="/admin/detalleAltaMedico" target="blank">SOL452</a></td>
                    <td>22/03/2017</td>
                    <td>Paco Venancio Torres</td>
                    <td>452265441</td>
                    <td>913657445</td>
                  ...
                  <tr>
                    <td><a href="/admin/detalleAltaMedico" target="blank">SOL222</a></td>
                    <td>22/03/2017</td>
